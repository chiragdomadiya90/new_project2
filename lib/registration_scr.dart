...
class Registration_Scr extends StatefulWidget {
  const Registration_Scr({Key? key}) : super(key: key);

  @override
  State<Registration_Scr> createState() => _Registration_ScrState();
}

class _Registration_ScrState extends State<Registration_Scr> {
